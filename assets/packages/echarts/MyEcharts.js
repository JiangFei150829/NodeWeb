        ...
        FormateGroupData: function (data, chart_type, isstack, showarea) {
            ...
            for (var i = 0; i < group.length; i++) {
                ...
                if (showarea) {
                    ...
                    if (isstack) {
                        series_temp = { name: group[i], stack: 'stack', data: temp, type: chart_type, itemStyle: itemStyle, smooth: true };
                    }
                    else {
                        series_temp = { name: group[i], data: temp, type: chart_type, itemStyle: itemStyle, smooth: true };
                    }
                }
                else {
                    if (isstack) {
                        series_temp = { name: group[i], stack: 'stack', data: temp, type: chart_type, smooth: true };
                    }
                    else {
                        series_temp = { name: group[i], data: temp, type: chart_type, smooth: true };
